...
export interface StaggeredTextProps {
  ...
  /** Optional per-segment class names (e.g. to vary font weight per word) */
  segmentClassName?: (segment: string, rowIndex: number) => string;
}
            ...
            {rowSegments.map((segment, rowSegIndex) => {
              ...
              return (
                <motion.span
                  ...
                  className={segmentClassName?.(segment, rowIndex)}
